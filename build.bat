...
xcopy /Y /S %targetfile% "F:\Clarity\Clarity-Servers\resources\[Scripts]\qdx_core\%folderToUse%"
xcopy /Y /S %targetfile% "F:\Clarity\sources\qdx_core\Client\MenuUI\%folderToUse%"
